...
import { PurchaseOrderLinesService } from 'app/entities/vscommerce/purchase-order-lines/purchase-order-lines.service';
...
describe('Service Tests', () => {
  describe('PurchaseOrderLines Service', () => {
    ...
    let expectedResult: IPurchaseOrderLines | IPurchaseOrderLines[] | boolean | null;
    ...
    describe('Service methods', () => {
      ...
      it('should create a PurchaseOrderLines', () => {
        ...
        service.create(new PurchaseOrderLines()).subscribe(resp => (expectedResult = resp.body));

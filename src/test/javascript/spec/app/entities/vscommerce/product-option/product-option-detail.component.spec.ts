...
import { ProductOptionDetailComponent } from 'app/entities/vscommerce/product-option/product-option-detail.component';
import { ProductOption } from 'app/shared/model/vscommerce/product-option.model';

...
import { StockItemsComponent } from 'app/entities/vscommerce/stock-items/stock-items.component';
...
describe('Component Tests', () => {
  describe('StockItems Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.stockItems && comp.stockItems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

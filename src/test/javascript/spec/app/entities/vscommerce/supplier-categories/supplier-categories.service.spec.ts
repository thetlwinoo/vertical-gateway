...
describe('Service Tests', () => {
  describe('SupplierCategories Service', () => {
    ...
    let expectedResult: ISupplierCategories | ISupplierCategories[] | boolean | null;
    ...
    describe('Service methods', () => {
      ...
      it('should create a SupplierCategories', () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            validFrom: currentDate.format(DATE_TIME_FORMAT),
        ...
        service.create(new SupplierCategories()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should update a SupplierCategories', () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            validFrom: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should return a list of SupplierCategories', () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            validFrom: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should delete a SupplierCategories', () => {

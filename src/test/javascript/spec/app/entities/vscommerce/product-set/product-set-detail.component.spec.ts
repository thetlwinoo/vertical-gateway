...
import { ProductSetDetailComponent } from 'app/entities/vscommerce/product-set/product-set-detail.component';
import { ProductSet } from 'app/shared/model/vscommerce/product-set.model';

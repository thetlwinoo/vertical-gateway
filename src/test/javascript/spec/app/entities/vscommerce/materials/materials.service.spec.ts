...
describe('Service Tests', () => {
  describe('Materials Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(MaterialsService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Materials(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Materials', () => {
        ...
        service.create(new Materials()).subscribe(resp => (expectedResult = resp.body));

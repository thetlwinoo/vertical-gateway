...
import { ProductSetDetailPriceUpdateComponent } from 'app/entities/zezawar/product-set-detail-price/product-set-detail-price-update.component';
import { ProductSetDetailPriceService } from 'app/entities/zezawar/product-set-detail-price/product-set-detail-price.service';
import { ProductSetDetailPrice } from 'app/shared/model/zezawar/product-set-detail-price.model';

...
import { ProductDocumentDeleteDialogComponent } from 'app/entities/zezawar/product-document/product-document-delete-dialog.component';
import { ProductDocumentService } from 'app/entities/zezawar/product-document/product-document.service';

...
import { ProductListPriceHistoryDeleteDialogComponent } from 'app/entities/zezawar/product-list-price-history/product-list-price-history-delete-dialog.component';
